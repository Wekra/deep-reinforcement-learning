...
class Agent:
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        if self.t_step == 0:
            # If enough samples are available in the replay memory, get a random subset and learn from it
    ...
    def learn(self, experiences, gamma):
        ...
        # Compute loss between expected and calculated Q values
    ...
    def soft_update(self, local_model, target_model, tau):
        ...
        Params
        ======
            local_model (PyTorch model): the network the weights will be copied from
            target_model (PyTorch model): the network the weights will be copied to
